...
<<rdd_ex_1_1, fig.pos="t", fig.height=3.5, fig.width=5, fig.cap="Exemplo em que Z satisfaz o critério backdoor para medir o efeito causal de X em Y e X = I(Z $>$ 0). Como resultado da descontinuidade da propensidade de X em Z = 0, há uma descontinuidade na regressão de Y em Z no ponto Z=0.", fig.align="center">>==
n <- 1000
Z <- rnorm(n)
X <- Z >= 0
