...
\begin{definition}
 \label{def:do_graph}
 Seja $(\sG,f)$ um SCM tal que $\sG = (\sV,\sE)$:
 \begin{align*}
  \sG(\bar{\V}) 
  &:= (\sV, \{E \in \sE: E_2 \notin \V\}) \\
...
\caption[Grafo de resultados potenciais dadas intervenções em $X$]{Grafo de resultados potenciais dadas intervenções em $X$.}\label{fig:grafo_potencial}
\end{figure}
...
\begin{lemma}
 ...
 Se $(\sG_*, f_*)$ é tal qual em \cref{def:scm_star}, então:
 \begin{align*}
...
\begin{lemma}
 ...
 Se $(\sG_*, f_*)$ é tal qual em \cref{def:scm_star} e
